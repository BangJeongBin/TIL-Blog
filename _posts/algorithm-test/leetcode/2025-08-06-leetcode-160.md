...
description: LeetCode 160 (Java)
 <br>
 [Intersection of Two Linked Lists] 문제 풀이
author: bin
...
> [문제 바로가기](https://leetcode.com/problems/intersection-of-two-linked-lists/description/)
...
public class Solution {
    public ListNode getIntersectionNode(ListNode headA, ListNode headB) {
        ...
        while(pointerA!=null || pointerB!=null){
            ...
            if(set.contains(pointerA)) return pointerA;
